...
$packageName= 'todolist' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'http://abstractspoon.pbworks.com/f/todolist_exe.zip' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'todolist*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = ''
